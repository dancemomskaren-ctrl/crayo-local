...
const TIPS = [
  ...
  "Run {highlight}./start-chipotlai.sh{/highlight} to launch with the Pepper proxy",
  "Use {highlight}/connect{/highlight} with Chipotle Pepper for burrito-powered inference",
