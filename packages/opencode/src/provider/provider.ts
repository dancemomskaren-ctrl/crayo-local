...
export namespace Provider {
  ...
  const state = Instance.state(async () => {
    ...
    const bots = [
      ["chipotle-pepper", "Chipotle Pepper", "pepper-1", "Pepper 1"],
      ["home-depot-magic-apron", "Home Depot Magic Apron", "magic-apron-1", "Magic Apron 1"],
      ["sephora-ai-beauty-chat", "Sephora AI Beauty Chat", "beauty-chat-1", "AI Beauty Chat 1"],
      ["nordstrom-rosie", "Nordstrom Rosie", "rosie-1", "Rosie 1"],
      ["lowes-mylow", "Lowe's Mylow", "mylow-1", "Mylow 1"],
      ["ikea-billie", "IKEA Billie", "billie-1", "Billie 1"],
      ["expedia-virtual-agent", "Expedia Virtual Agent", "virtual-agent-1", "Virtual Agent 1"],
    ] as const
